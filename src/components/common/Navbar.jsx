...
const Navbar = () => {
  ...
  // Helper function for smooth scrolling (optional but robust)
    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between">
          ...
          {/* Right Action Button (Buy Now -> Products) */}
          <div className="hidden md:flex items-center gap-6">
            <motion.a 
              ...
              whileTap={{ scale: 0.95 }}
              className="px-6 py-2.5 bg-[#39ff14] text-black font-black text-[11px] uppercase tracking-wider rounded-full cursor-pointer"
            >
              Buy Now
            </motion.a>
          </div>
          ...
          {mobileMenuOpen && (
            ...
            >
              ...
              <motion.a 
                ...
                className="mt-8 w-full max-w-xs py-4 bg-[#39ff14] text-center text-black font-black rounded-full uppercase tracking-widest text-sm shadow-[0_10px_30px_rgba(57,255,20,0.3)]"
              >
                Buy Now
              </motion.a>
            </motion.div>
